...
Mikäli kilpailussa on tuomaristo, voidaan sääntöjä tarkentaa painavasta syystä viimeistään ennen kilpailulähtöä. Seuraa simulaattorin chattia tai sarjan tiedotusta odotusaikoina.
...
Ajopaikan puolustaminen on sallittua.  

Ajolinjan peittäminen on tehtävä ennen jarrutusta.
...
## 9.1 Yleistä
Tässä luvussa määritellään sarjan rangaistuskäytäntö, jonka tavoitteena on edistää reilua ja turvallista kilpailua sekä puuttua tehokkaasti toistuviin tai vakaviin rikkeisiin. Rangaistusjärjestelmä perustuu kumulatiivisiin rangaistuspisteisiin (RP) ja niiden vaikutukseen sarjapisteisiin.
...
Tuomaristo voi määrätä kuljettajalle rangaistuspisteitä kussakin kilpailussa todettujen rikkomusten perusteella. Rangaistuspisteet ovat kumulatiivisia koko kauden ajan, mutta niihin sovelletaan laskennallista vähennystä (ks. kohta 9.2.3).
...
- Sarjapistemenetyksen korottaminen – rikkomuksen vakavuus ja sen vaikutus rikotun kuljettajan kilpailuasemaan otetaan huomioon kokonaisharkinnassa  
- Aikasanktio tai sijoituksen menetys – mikäli kuljettaja on rikkonut sääntöjä tahallisesti estääkseen kanssakilpailijaa saavuttamasta tarvittavaa sijoitusta tietyssä kilpailussa, voidaan rikkovaa kuljettajaa rangaista myös aikasakolla tai kisasijoituksen menettämisellä  
...
Rangaistusjärjestelmä on suuntaa antava. Tuomaristolla on oikeus poiketa ohjearvoista, mikäli tilanteen erityispiirteet sitä vaativat.
...
|---|---|
| 75–100 % | Kilpailu päätetään |
| 50–75 % | Kilpailu päätetään, pisteet puolitetaan |
| 0–50 % | Uusintalähtö |
